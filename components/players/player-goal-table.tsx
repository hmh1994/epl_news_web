...
import { getPlayerGoalRank } from "@/src/entities/players/apis/get-player-goal-rank";

export async function PlayerGoalTable() {
  const { playerGoalRank } = await getPlayerGoalRank();
  return (
      ...
      <div className='rounded-md border overflow-hidden'>
        <div className='overflow-x-auto'>
          <table className='w-full text-sm'>
            ...
            <tbody>
              {playerGoalRank.map((player, index) => (
                <tr
                  key={index}
                  className={`${
