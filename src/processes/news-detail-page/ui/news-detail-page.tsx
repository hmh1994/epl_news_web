      ...
      <div className='space-y-10'>
        ...
        <div className='grid gap-10 lg:grid-cols-[minmax(0,1fr)_280px]'>
          <div className='space-y-6'>
            <section className='rounded-3xl border border-white/10 bg-slate-900/40 p-8 text-sm text-slate-300 shadow-xl shadow-slate-500/5'>
            ...
            {article.externalUrl && (
              <a
                ...
                className='inline-flex items-center gap-2 rounded-full border border-slate-400/30 bg-slate-500/10 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:border-slate-300/60 hover:text-white'
              >
