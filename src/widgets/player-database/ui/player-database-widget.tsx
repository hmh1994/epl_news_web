      ...
      <main className='max-w-7xl mx-auto px-6 mt-12 lg:mt-16'>
        ...
        >
          {showSearchResults ? (
            <>
              ...
              {isPending ? (
                <div className='rounded-2xl border border-white/10 bg-slate-950/60 px-6 py-10 text-center text-slate-300'>
                  선수 데이터를 불러오는 중입니다...
                </div>
              ) : (
                <>
            ...
            <div className='rounded-2xl border border-dashed border-white/10 bg-slate-950/40 px-6 py-10 text-center text-slate-400'>
        ...
        <div className='space-y-8'>
          <div className='flex items-center justify-between'>
            ...
            <div className='rounded-full border border-white/10 bg-slate-900/60 px-4 py-2 text-xs font-semibold text-slate-200'>
              총 {players.length}명
            </div>
          </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
            {rankingGroups.map((group) => {
              ...
              return (
                <div
                  key={group.id}
                  className='bg-slate-950/60 rounded-3xl p-6 border border-white/10 shadow-[0_18px_40px_rgba(2,6,23,0.35)]'
                >
                  ...
                  <div className='space-y-3'>
                    {rankedPlayers.map((player, index) => {
                      return (
                        ...
                        >
                          <div className='flex items-center gap-3'>
                            <div className='h-9 w-9 rounded-xl bg-slate-900/70 border border-white/10 flex items-center justify-center text-sm font-semibold text-white'>
                              {index + 1}
                            </div>
                            <div>
