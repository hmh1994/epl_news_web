...
export const PlayerDatabaseHero = () => {
  ...
  return (
    <section className='relative pt-28 pb-14'>
      <div className='absolute inset-0 bg-[radial-gradient(circle_at_30%_-10%,rgba(16,185,129,0.14),transparent_50%),radial-gradient(circle_at_80%_0%,rgba(20,184,166,0.1),transparent_45%)]' />
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6 text-center'>
        <h1 className='text-4xl sm:text-5xl lg:text-6xl font-semibold mb-6 leading-tight tracking-tight'>
          ...
          <br />
          <span className='text-emerald-200'>{t("title.secondary")}</span>
        </h1>
