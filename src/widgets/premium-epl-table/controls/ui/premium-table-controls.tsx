...
export const PremiumTableControls = ({
  ...
  <div className='mb-12'>
    <div className='bg-slate-950/60 rounded-3xl p-4 md:p-6 lg:p-8 border border-white/10 shadow-[0_18px_40px_rgba(2,6,23,0.35)]'>
      <div className='flex flex-col lg:flex-row gap-6'>
        <div className='relative flex-1'>
          ...
          <input
            ...
            name='team-search'
            autoComplete='off'
            className='w-full bg-slate-900/60 border border-white/10 rounded-2xl pl-14 pr-5 py-3 md:py-5 text-white placeholder-slate-500 focus:outline-none focus:border-slate-400/40 focus:ring-1 focus:ring-slate-400/20 transition-colors text-base md:text-lg'
            value={searchTerm}
        ...
        <div className='flex flex-wrap gap-2 md:gap-4 items-center'>
          <div className='flex items-center space-x-3 bg-slate-900/60 rounded-2xl px-4 py-3 border border-white/10'>
            <div className='w-2.5 h-2.5 bg-slate-300/70 rounded-full'></div>
